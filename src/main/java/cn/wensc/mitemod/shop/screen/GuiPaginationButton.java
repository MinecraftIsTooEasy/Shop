...
public class GuiPaginationButton extends GuiButton {
    private static final ResourceLocation t = new ResourceLocation(ShopInit.ShopModID, "textures/gui/container/gui_shop.png");
    ...
    public void drawButton(Minecraft var1, int var2, int var3) {
        if (this.drawButton) {
            var1.getTextureManager().bindTexture(t);
